...
public class CorHttpd extends CordovaPlugin {
    ...
    private static final String OPT_ERROR_PAGE = "error_page";
    ...
    private PluginResult startServer(JSONArray inputs, CallbackContext callbackContext) {
        ...
        error_page = options.optString(OPT_ERROR_PAGE);
    ...
    private String __startServer() {
        ...
        try {
            ...
            if(localhost_only) {
                ...
                server = new WebServer(localAddr, f, error_page);
            } else {
                server = new WebServer(port, f, error_page);
            }
        } catch (IOException e) {
